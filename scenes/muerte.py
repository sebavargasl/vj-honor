...
def gameOver():
    ...
    boton_jugar=pygame.Rect(1000/2-200, 700/2-50, 400, 50)
    boton_cerrar=pygame.Rect(1000/2-100, 700/2+50, 200, 50)

    texto_jugar= letra_inicio.render("JUGAR DE NUEVO",True,(255,255,255))
    texto_cerrar=letra_inicio.render("SALIR",True,(255,255,255))
    texto_titulo=letra_titulo.render("GAME OVER", True, (255,0,0))
    ...
    pygame.display.set_caption("Pantalla de muerte")
